...
export default function AdminVenuesPage() {
  ...
  return (
    <div className="p-8 max-w-7xl">
      <h1 className="font-headline font-bold text-2xl mb-6">Venue Management</h1>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/5">
                <th className="text-left px-5 py-3.5 text-xs font-semibold text-outline uppercase tracking-wide">Venue</th>
                <th className="text-left px-5 py-3.5 text-xs font-semibold text-outline uppercase tracking-wide">Owner</th>
                <th className="text-left px-5 py-3.5 text-xs font-semibold text-outline uppercase tracking-wide">Type</th>
                <th className="text-right px-5 py-3.5 text-xs font-semibold text-outline uppercase tracking-wide">Capacity</th>
                <th className="text-right px-5 py-3.5 text-xs font-semibold text-outline uppercase tracking-wide">Bookings</th>
            ...
            <tbody>
              {venues.map((venue, i) => (
                ...
                >
                  ...
                  <td className="px-5 py-3.5 text-on-surface-variant">{venue.owner}</td>
                  <td className="px-5 py-3.5">
                    <Badge variant="default">{venue.type}</Badge>
                  </td>
                  <td className="px-5 py-3.5 text-right text-on-surface">{venue.capacity}</td>
                  <td className="px-5 py-3.5 text-right text-on-surface font-medium">{venue.bookings}</td>
                  <td className="px-5 py-3.5">
