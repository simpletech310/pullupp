  ...
  if (!hasAccess) {
    return (
      <div className="px-4 pt-8 text-center">
        <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-surface-container border border-white/5 flex items-center justify-center">
          <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-outline">
            <rect x="3" y="11" width="18" height="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" />
          </svg>
        </div>
        <h2 className="font-headline font-bold text-lg mb-2">Access Restricted</h2>
  ...
  return (
    <div className="pb-24">
      ...
      <div className="px-4 pt-4 pb-3 flex items-center gap-3">
        ...
        <h1 className="font-headline font-bold text-xl">Get Paid with Stripe</h1>
      </div>
      ...
      <div className="px-4 space-y-5">
            ...
            <Card className="p-5">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-outline text-xs mt-0.5 font-body">Your Stripe account is ready to receive payments</p>
                </div>
              </div>
              ...
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  <div className="w-8 h-8 shrink-0 rounded-lg bg-orange/10 flex items-center justify-center">
                    {item.icon === 'dollar' && (
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary-container">
        ...
        {/* FAQ Section */}
        <div>
          <h3 className="font-headline font-semibold text-base mb-3">Frequently Asked Questions</h3>
              ...
              <Card key={index} className="overflow-hidden">
                ...
                >
                  ...
                  <svg
                    ...
                    className={`shrink-0 text-outline transition-transform duration-200 ${expandedFaq === index ? 'rotate-180' : ''}`}
                  >
