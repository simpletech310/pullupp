    ...
    <div className="px-4 pt-6 space-y-6">
      ...
      <div className="flex gap-2 overflow-hidden">
        {[...Array(4)].map((_, i) => (
          <div
            key={i}
            className="bg-surface-alt animate-pulse rounded-full h-8 w-24 shrink-0"
          />
        ))}
      </div>
      ...
      <div className="space-y-4">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="bg-surface rounded-lg border border-border overflow-hidden">
            <div className="bg-surface-alt animate-pulse h-36" />
            <div className="p-4 space-y-2">
              ...
              <div className="bg-surface-alt animate-pulse rounded-lg h-3 w-2/3" />
            </div>
          </div>
        ))}
      </div>
