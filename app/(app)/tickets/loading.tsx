  ...
  return (
    <div className="px-4 pt-6 space-y-6">
      ...
      <div className="flex gap-4">
        <div className="bg-surface-alt animate-pulse rounded-lg h-10 w-32" />
        <div className="bg-surface-alt animate-pulse rounded-lg h-10 w-32" />
      </div>
      ...
      <div className="space-y-4">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="bg-surface rounded-lg border border-border overflow-hidden">
            <div className="bg-surface-alt animate-pulse h-3 rounded-t-lg" />
            <div className="p-4 space-y-3">
              ...
              <div className="bg-surface-alt animate-pulse rounded-lg h-4 w-1/3" />
              <div className="bg-surface-alt animate-pulse rounded-lg h-10 w-full mt-2" />
            </div>
          </div>
        ))}
      </div>
