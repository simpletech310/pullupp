  ...
  return (
    <div className="px-4 pt-8 space-y-6">
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="bg-surface-container-high animate-pulse rounded-lg h-6 w-36" />
        <div className="bg-surface-container-high animate-pulse rounded-full h-6 w-20" />
      </div>
      ...
      <div className="flex justify-center gap-6">
        {[...Array(3)].map((_, i) => (
          <div key={i} className="flex flex-col items-center gap-1">
            <div className="bg-surface-container-high animate-pulse rounded-lg h-6 w-10" />
      ...
      <div className="space-y-2">
        {[...Array(5)].map((_, i) => (
          ...
          >
            <div className="bg-surface-container-high animate-pulse rounded-lg h-8 w-8" />
